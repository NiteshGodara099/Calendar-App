...
const CalendarApp = () => {
  const [currentDate, setCurrentDate] = useState(new Date()); // Live date
      ...
      <div className="relative w-full max-w-4xl mx-4 bg-gray-800 p-8 rounded-3xl border-8 border-gray-700 flex shadow-2xl">
        ...
        <div className="flex-1 pr-6">
          <div className="flex justify-between items-center mb-6">
            ...
            {showMonthYearPicker && (
              <div className="absolute bg-gray-700 rounded-lg p-4 mt-2">
                <select
                  className="bg-gray-800 text-white p-2 rounded mb-2"
                  value={month}
                  onChange={(e) =>
                    handleMonthYearSelect(Number(e.target.value), year)
                  }
                >
                  {monthNames.map((m, i) => (
                ...
                <input
                  ...
                  value={year}
                  onChange={(e) =>
                    handleMonthYearSelect(month, Number(e.target.value))
                  }
